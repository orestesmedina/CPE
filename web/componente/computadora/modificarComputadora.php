                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <form action="../../../control/components/computadora/modificarController.php" method="POST" role="form">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Número de placa</label>
                                                <input type="text" name="placa" class="form-control" placeholder="Ingrese parametro de búsqueda" required pattern="[0-9]{1,10}" maxlength="10" title="ingrese solo números, mínimo once digitos">
