    ...
    <body>
        ...
        <div id="wrapper">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="../../../web/prestamo/computadora/nuevo.php">Nuevo préstamo</a>
                                            </li>

                                            <li>
                                                <a href="../../../web/prestamo/computadora/devolver.php">Devolver préstamo</a>
                                            </li>
                                        </ul>
                                        <!-- /.nav-third-level -->
                                    </li>
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="../../../web/prestamo/impresora/nuevo.php">Nuevo préstamo</a>
                                            </li>

                                            <li>
                                                <a href="../../../web/prestamo/impresora/devolver.php">Devolver préstamo</a>
                                            </li>
                                        </ul>
                                        <!-- /.nav-third-level -->
                                    </li>
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="../../../web/prestamo/proyector/nuevo.php">Nuevo préstamo</a>
                                            </li>

                                            <li>
                                                <a href="../../../web/prestamo/proyector/devolver.php">Devolver préstamo</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="../../../web/prestamo/telefono/nuevo.php">Nuevo préstamo</a>
                                            </li>

                                            <li>
                                                <a href="../../../web/prestamo/telefono/devolver.php">Devolver préstamo</a>
                                            </li>
                                        </ul>
                                        <!-- /.nav-third-level -->
                                    </li>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> Nuevo Préstamo</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Préstamo computadora
                            </div>
                            <div class="panel-body">
                                <div class="row">

                                    <form action="../../../control/prestamo/computadora/InsertarController.php" method="POST" role="form" id="nuevaComputadora">
                                        <div class="col-lg-6">
