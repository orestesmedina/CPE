                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            ...
                                            <li>
                                                <a href="computadora/prestamo/asignacion/modificar.php">Devolver préstamo</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <form action="../../../control/asignacion/impresora/ModificarController.php" method="POST" role="form" id="nuevaComputadora">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-default" onclick="buscarImpresora('modificar');">
