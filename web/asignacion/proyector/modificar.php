                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <form action="../../../control/asignacion/proyector/ModificarController.php" method="POST" role="form" id="nuevaComputadora">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-default" onclick="buscarProyector('modificar');">
